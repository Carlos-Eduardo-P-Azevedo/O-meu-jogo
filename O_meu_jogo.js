...
var chao2,chao2img;
var chao3,chao3img;
var teletransporte1,teletransporte2,teletransporte3,teletransporte4;
...
function setup(){
  ...
  teletransporte4 = createSprite(-50,0,30,50);
  ...
  teletransporte2 = createSprite(-50,-50,50,30);
  ...
  areadeataque1 = createSprite(width/2,height/2,50,15);
  areadeataque1.shapeColor = "DimGray";

  areadeataque2 = createSprite(width/2,height/2,50,15);
  areadeataque2.shapeColor = "DimGray";

  areadeataque3 = createSprite(width/2,height/2,15,50);
  areadeataque3.shapeColor = "DimGray";

  areadeataque4 = createSprite(width/2,height/2,15,50);
  ...
  caminho1 = createSprite(width/2,height/2,300,300);
  caminho2 = createSprite(width/2,height/2,300,300);
  caminho3 = createSprite(width/2,height/2,300,300);
  caminho4 = createSprite(width/2,height/2,300,300);
  caminho5 = createSprite(width/2,height/2,300,300);
  caminho6 = createSprite(width/2,height/2,300,300);
  caminho7 = createSprite(width/2,height/2,300,300);
  caminho8 = createSprite(width/2,height/2,300,300);

  caminho9 = createSprite(width/2,height/2,100,100);
  caminho10 = createSprite(width/2,height/2,100,100);
  caminho11 = createSprite(width/2,height/2,100,100);
  caminho12 = createSprite(width/2,height/2,100,100);
  caminho13 = createSprite(width/2,height/2,100,100);
  caminho14 = createSprite(width/2,height/2,100,100);
  caminho15 = createSprite(width/2,height/2,100,100);
  caminho16 = createSprite(width/2,height/2,100,100);

  caminho17 = createSprite(width/2,height/2,30,30);
  caminho18 = createSprite(width/2,height/2,30,30);
  caminho19 = createSprite(width/2,height/2,30,30);
  caminho20 = createSprite(width/2,height/2,30,30);
...
//  Engine.update(engine);
  ...
  if(player.isTouching(teletransporte1)){
    ...
    teletransporte2.y = height/2+280;
    ...
    teletransporte1.y = -50;
    teletransporte3.x = -50;
    teletransporte3.y = -50;

    cesta = createSprite(width/2,height/2);
    cesta.addImage(cestaimg);
    cesta.scale = 2;
    cesta.setCollider("rectangle",0,10,50,30);
  ...
  if(player.isTouching(teletransporte3)){
    ...
    teletransporte4.y = height/2+243;
  ...
  if(jogoprincipal == jogo1){
    ...
    if(player.isTouching(teletransporte2)){
      ...
      teletransporte2.y = -50;

      teletransporte1.x = width/2-200;
      teletransporte1.y = height/2+150;
      teletransporte3.x = width/2+200;
      teletransporte3.y = height/2+150;
  ...
  if(jogoprincipal == jogo2){
    ...
    if(minichefe.x > 500){valor1 = valor1+1}else{valor1 = 0};
...
function fruit(){
    ...
    switch(frutas){
      case 1: if(banana1.x < 360){banana1.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      case 2: if(banana2.x < 360){banana2.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      case 3: if(banana3.x < 360){banana3.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      case 4: if(banana4.x < 360){banana4.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      case 5: if(banana5.x < 360){banana5.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      case 6: if(maca1.x < 360){maca1.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      case 7: if(maca2.x < 360){maca2.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      case 8: if(maca3.x < 360){maca3.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      case 9: if(maca4.x < 360){maca4.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      case 10: if(maca5.x < 360){maca5.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      case 11: if(laranja1.x < 360){laranja1.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      case 12: if(laranja2.x < 360){laranja2.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      case 13: if(laranja3.x < 360){laranja3.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      case 14: if(laranja4.x < 360){laranja4.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      case 15: if(laranja5.x < 360){laranja5.x = Math.round(random(width/2-350,width/2+350));}else{fruit();}
      break;
      default: break;}}
